...
ORDER BY a.attnum ASC"""  # noqa: S608
    ...
    def list_materialized_views(
        ...
        *,
        ...
        Queries the mz_materialized_views catalog table to list all
        materialized views in the specified database/schema.
    ...
    def list_sources(
        ...
        *,
        ...
        Queries the mz_sources catalog table to list all sources
    ...
    def alter_cluster(
        ...
        *,
        ...
        Supports renaming clusters, modifying configuration options, and resetting
    ...
    def list_clusters(
        ...
        *,
        ...
        Queries the mz_clusters catalog table to list all clusters.
