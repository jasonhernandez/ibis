...
class MaterializeType(PostgresType):
    ...
    @classmethod
    def _from_ibis_UInt8(cls, dtype: dt.UInt8) -> NoReturn:
        raise com.UnsupportedBackendType(
            "Materialize doesn't support 1-byte unsigned integers (uint8/UInt8). "
            "Use uint16 or larger. Ref: https://materialize.com/docs/sql/types/uint/"
        )
